...
struct TeacherDetailPage: View {
    ...
    private var importantInfoCard: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack(spacing: 10) {
                infoMetricCard(title: "入职日期", value: teacher.onboardDate, symbol: "calendar.badge.clock")
                infoMetricCard(title: "教龄", value: teacher.yearsOfTeaching, symbol: "clock.badge.checkmark")
                infoMetricCard(title: "毕业院校", value: teacher.graduateSchool, symbol: "graduationcap.fill")
            }
        }
        .padding(14)
        .background(JWColor.surface)
    ...
    private func infoMetricCard(title: String, value: String, symbol: String) -> some View {
